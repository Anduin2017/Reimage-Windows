...
function Invoke-ComputerInitializationInCurrentSession {
    ...
    Invoke-WebRequest -Uri "https://gitlab.aiursoft.com/anduin/reimage-windows/-/archive/master/reimage-windows-master.zip" -UseBasicParsing -OutFile $destinationPath
